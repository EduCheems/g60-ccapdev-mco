...
export const SpotlightSection = ({ catName, foodName,catImage, foodImage }: SpotlightSectionProps) => {
  return (
    <div className="flex flex-col md:flex-row gap-6 w-full mt-12 items-stretch shadow-[inset_6px_6px_4px_rgba(133,82,37,0.2)]">
      <div className="flex-1 flex">
        <CatSpotlight name={catName} image={catImage} />
      </div>
      <div className="flex-1 flex">
        <BestBuyer name={foodName} image={foodImage} />
      </div>
    </div>
  );
};
