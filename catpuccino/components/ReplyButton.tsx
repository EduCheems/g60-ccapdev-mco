...
export default function ReplyButton({ replyCount }: ReplyButtonProps) {
  return (
    <button className="flex items-center gap-2 border-[1.5px] border-black rounded-full shadow-[inset_4px_4px_1px_rgba(133_82_37_/_0.2)] px-5 py-1.5 hover:bg-black/5 transition-colors">
